...
public class Gdistance {
    ...
    public static List<Double> distances(Graph graph1, Graph graph2, String locationMapName, char delimiter) {
        ...
        //before everything else, I need to load the coordinate map into a Data object.
        String workingDirectory = System.getProperty("user.dir");
        System.out.println(workingDirectory);
        Path mapPath = Paths.get(locationMapName);
        System.out.println(mapPath);
        edu.cmu.tetrad.io.DataReader dataReaderMap = new TabularContinuousDataReader(mapPath, delimiter);
    ...
    private static double nodesDistance(Node node1, Node node2, DataSet locationMap) {
        ...
        //from here I calculate taxicab distance, but a different distance could be used instead.
