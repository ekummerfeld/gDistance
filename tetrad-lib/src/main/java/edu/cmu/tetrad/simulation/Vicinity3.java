...
public class Vicinity3 {
    ...
    //In this version, I have made range an input to the getVicinity method
    //private int range = 6;
    //these are the separate maps, one for each axis
    ...
    public Vicinity3(List<Edge> edges, DataSet locationMap, int xLow, int xHigh, int yLow, int yHigh, int zLow, int zHigh) {
        ...
        //this is the part where the independent maps are updated independently.
        for (Edge edge : edges) {
    ...
    //range should actually be used as an input to this function, so that it can be varied
    public List<Edge> getVicinity(Edge edge, DataSet locationMap,int range) {
